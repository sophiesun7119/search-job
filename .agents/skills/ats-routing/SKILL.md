...
If the bounded investigation cannot establish an official provider, record the attempted evidence and exact blocker with `--ai-review-lead KEY --ai-review-outcome needs-user --review-note "..."`. The local review Dashboard will then identify the company and show its original Simplify profile, company URL when supplied, original sample Job URL, redirect, candidate official URL, script error, and AI note. Tell the user what link or fact would resolve the blocker. A script-created AI work item is not a completed investigation. Hand confirmed routes to board verification or adapter development.
